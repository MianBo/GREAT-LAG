...
namespace gnut
{
    ...
    t_map_gnss GNSS_DATA_PRIORITY()
    {
        ...
        m[LEO][BAND_1][TYPE_C] = { ATTR_C };
        m[LEO][BAND_1][TYPE_L] = { ATTR_C };
        m[LEO][BAND_1][TYPE_D] = { ATTR_C };
        m[LEO][BAND_1][TYPE_S] = { ATTR_C };

        m[LEO][BAND_2][TYPE_C] = { ATTR_C };
        m[LEO][BAND_2][TYPE_L] = { ATTR_C };
        m[LEO][BAND_2][TYPE_D] = { ATTR_C };
        m[LEO][BAND_2][TYPE_S] = { ATTR_C };
